...
val ROLE_MAP = mapOf(
    ...
    "telephone-string" to "17705507550",
    ...
    "company-string" to "南京云联数科科技有限公司",
    "timestamp-long" to System.currentTimeMillis(),
    ...
    "birthday-long" to System.currentTimeMillis(),
    "code-string" to RandomUtil.randomInt(100, 99999).toString(),
    "message-string" to "success,fail".split(",")[RandomUtil.randomInt(0, 1)],
